...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ['usuario', 'title', 'product_image', 'price', 'category', 'vendor', 'featured', 'product_status', 'pid']

class CategoryAdmin(admin.ModelAdmin):
    list_display = ['title', 'category_image']

class VendorAdmin(admin.ModelAdmin):
    list_display = ['title', 'vendor_image', 'cover_image']


class CartOrderAdmin(admin.ModelAdmin):
    list_editable = ['paid_status', 'product_status', 'sku']
    list_display = ['usuario',  'price', 'paid_status', 'order_date','product_status', 'sku']
...
class ProductReviewAdmin(admin.ModelAdmin):
    list_display = ['usuario', 'product', 'review', 'rating']


class wishlistAdmin(admin.ModelAdmin):
    list_display = ['usuario', 'product', 'date']


class AddressAdmin(admin.ModelAdmin):
    list_editable = ['address', 'status']
    list_display = ['usuario', 'address', 'status']
